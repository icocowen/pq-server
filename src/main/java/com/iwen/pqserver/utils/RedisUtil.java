...
public class RedisUtil {
    ...
    @Value("${pqchat.chat-time-list-prefix}")
    private String chatTimeListPrefix;
    ...
    public Long sSetMemberSize(String key) {
        try {
    ...
    public Set<Object> getAllMessageSet(String key) {
    ...
    public void zSetAdd(String key, long score, Object obj) {
     ...
     * @return
     */
    public Integer getLastMessageTime(String key) {
        try{
     ...
     * 通过索引 获取list中的值
     * @param key 键
     * @param index 索引 index>=0时， 0 表头，1 第二个元素，依次类推；index<0时，-1，表尾，-2倒数第二
    个元素，依次类推
     * @return
     */
